...
def main() -> int:
    ...
    required_pb48_pb49_pb50_pb51_pb52_pb53_pb54_phrases = [
        ...
        ("testing_protocol.md", "Direct-link test"),
        ("testing_protocol.md", "Link-label test"),
        ("testing_protocol.md", "Fallback-navigation test"),
        ...
        ("output_templates.md", "Link status: DIRECT / FALLBACK / NOT VERIFIED"),
    ]
