...
No Premature User Handoff: before Codex/manual fallback, check safe connector/API/narrower write/PR/workflow/package route; user-only only after blocked routes/evidence.
