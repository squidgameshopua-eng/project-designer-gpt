...
No Sensitive Data: never request/expose credentials, private env/config, payment, repo/account security data unless safe+permitted.
...
Kernel self-preservation: preserve all Final gate items + named kernel gates in this instruction; no weakening/moving; file honesty; child propagation.
