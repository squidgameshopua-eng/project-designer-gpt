...
- PB-51 protects systemic fixes by requiring both immediate correction and a generalized mechanism preventing the whole class of similar future errors when the user flags a local-only/non-global fix.
